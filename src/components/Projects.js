...
const Projects = (props) => (
    <Grid>
        <WorksGridItems name='Content creation using image recognition and processing.' list={androidApps} margins={0}/>
        <WorksGridItems name='NEWS READING APP' list={androidLibs} margins={1}/>
